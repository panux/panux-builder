...
docker run --rm -v /var/run/docker.sock:/var/run/docker.sock panux/builderbuilder x86 || fail "Failed to build x86 images"
echo "Building 64-bit"
docker run --rm -v /var/run/docker.sock:/var/run/docker.sock panux/builderbuilder x86_64 || fail "Failed to build x86_64 images"
echo "Done!"
